...
// exit();
	...
	if($upload !='') { 
		...
		if($num > 0)
		{
			...
			echo '<script>';
			echo "alert('ขออภัย Username ของท่านมีผู้ใช้งานแล้ว กรุณากรอก Username ใหม่อีกครั้ง');";
			echo "window.location='หน้าสมัครใหม่Usernameซ้ำ.php';";
			echo '</script>';
	...
	if($result){
	echo '<script>';
    echo "alert('สมัครสมาชิกสำเร็จ ยินดีต้อนรับเข้าสู่ KAB SHOP');";
